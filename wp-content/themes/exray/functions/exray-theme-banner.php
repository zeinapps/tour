...
class Exray_Banner_Widget extends WP_Widget{
    ...
    public function __construct(){
        parent::__construct(
            ...
            array('description' => __(' Display a single Image banner','exray'))
        );
    }
    ...
    public function  form($instance) {
        ...
        ?>
			...
			<!-- Ad Title  -->
            <p>
                <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'exray'); ?></label>
				<input type="text" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" class="widefat" value="<?php echo esc_attr($instance['title']); ?>" />
            </p>
			
			<!-- Ad Image -->
            <p>
                <label for="<?php echo $this->get_field_id('ad_img'); ?>"><?php _e('Image URL', 'exray'); ?></label>
			...
			<!-- Ad Link -->
            <p>
                <label for="<?php echo $this->get_field_id('ad_link'); ?>"><?php _e('Image Link', 'exray'); ?></label>
            ...
            <!-- Ad Width -->
            <p>
                <label for="<?php echo $this->get_field_id('ad_width'); ?>"><?php _e('Width', 'exray'); ?></label>
            ...
            <!-- Ad Height -->
            <p>
                <label for="<?php echo $this->get_field_id('ad_height'); ?>"><?php _e('Height', 'exray'); ?></label>
