...
function exray_theme_customize_css(){ 
	...
	$default_options = array( 'display_logo' => true, 'exray_theme_logo' => THEME_IMAGES.'/logo.png' , 'display_top_ad' => '0', 'top_ad' => 'http://lorempixel.com/468/60', 'top_ad_link' => home_url(), 'top_menu_color' => '#f5f5f5', 'link_color' => '#0d72c7', 'header_color' => '#ffffff', 'main_menu_color' => '#f5f5f5', 'bg_color' => '#ffffff', 'footer_color' => '#f7f7f7', 'copyright_container_color' => '#ededed', 'display_logo ' => true, 'display_top_ad' => true, 'top_ad_link' => home_url(), 'content_options' => 'default');
	$customizer_options        = get_option( 'exray_custom_settings', $default_options);  
	$top_menu_color            = Exray::validate_var(array_key_exists('top_menu_color', $customizer_options) ? $customizer_options['top_menu_color'] : '#f5f5f5' , '#f5f5f5') ;
	$main_menu_color           = Exray::validate_var(array_key_exists('main_menu_color', $customizer_options) ? $customizer_options['main_menu_color'] : '#f5f5f5' , '#f5f5f5');
	$link_color                = Exray::validate_var(array_key_exists('link_color', $customizer_options) ? $customizer_options['link_color'] : '#0d72c7',  '#0d72c7');
	$header_color              = Exray::validate_var(array_key_exists('header_color', $customizer_options) ? $customizer_options['header_color'] : '#ffffff',  '#ffffff') ; 
	$bg_color                  = Exray::validate_var(array_key_exists('bg_color', $customizer_options) ? $customizer_options['bg_color'] : '#ffffff',  '#ffffff');
	$footer_color              = Exray::validate_var(array_key_exists('footer_color', $customizer_options) ? $customizer_options['footer_color'] : '#f7f7f7',  '#f7f7f7') ; 
	$copyright_container_color = Exray::validate_var(array_key_exists('copyright_container_color', $customizer_options) ? $customizer_options['copyright_container_color'] : '#ededed',  '#ededed') ;
