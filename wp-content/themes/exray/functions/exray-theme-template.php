...
function exray_widget_init(){
	register_sidebar(
		array(
			'name' => __( 'Header widget', 'exray' ),
			'id' => 'header-widget',
			'description' => __('The header widget area', 'exray'),
	...
	register_sidebar(
		array(
			'name' => __( 'Below Header', 'exray' ),
			'id' => 'below-header',
			'description' => __('Below header widget area', 'exray'),
	...
	register_sidebar(
		array(
			'name' => __( 'Primary', 'exray' ),
			'id' => 'primary',
			'description' => __('The left sidebar area', 'exray'),
	...
	register_sidebar(array(
			'name' => __( 'Secondary', 'exray' ),
			'id' => 'secondary',
			'description' => __('The right sidebar area', 'exray'),
	...
	register_sidebar(array(
			'name' => __('First Footer','exray'),
			'id' => 'first-footer',
			'description' => __('The first footer from left','exray'),
	...
	register_sidebar(array(
			'name' => __('Second Footer','exray'),
			'id' => 'second-footer',
			'description' => __('The second footer from left','exray'),
			'before_widget' => '<div class="span3"> <aside class="footer-widget" role="complementary">',
			'after_widget' => '</aside> </div> <!-- End span 3 Footer -->',
			'before_title' => '<h4 class="widget-title" role="heading">',
			'after_title' => '</h4>',
	...
	register_sidebar(array(
			'name' => __('Third Footer','exray'),
			'id' => 'third-footer',
			'description' => __('The third footer from left','exray'),
			'before_widget' => '<div class="span3"> <aside class="footer-widget" role="complementary">',
			'after_widget' => '</aside> </div> <!-- End span 3 Footer -->',
			'before_title' => '<h4 class="widget-title" role="heading">',
			'after_title' => '</h4>',
	...
	register_sidebar(array(
			'name' => __('Fourth Footer','exray'),
			'id' => 'fourth-footer',
			'description' => __('The fourth footer from left','exray'),
			'before_widget' => '<div class="span3"> <aside class="footer-widget" role="complementary">',
			'after_widget' => '</aside> </div> <!-- End span 3 Footer -->',
			'before_title' => '<h4 class="widget-title" role="heading">',
			'after_title' => '</h4>',
		...
		<li id="comment-<?php comment_ID(); ?>">
			...
			<article <?php comment_class('comment-content clearfix'); ?>>
				...
				<header>
					...
					<p>
						...
						<?php if( current_user_can('edit_comment') ) { 
							echo '- '; edit_comment_link(__('Edit comment', 'exray'), '', ''); 
						} ?>
					</p>
				...
				<?php if($comment->comment_approved == '0'): ?>
					...
					<p class="awaiting-moderation"><?php _e('Your comment is awaiting moderation','exray'); ?></p>
...
?>
	...
	<div class="entry-meta">	
		<p class="article-meta-extra">
			...
			if(current_user_can('edit_post', $post->ID)){
         		edit_post_link(__('Edit', 'exray'), '&nbsp;<p><span class="icon">S</span>&nbsp;', '</p>', '');
         	}
	...
	<div class="entry-meta">								
		<p class="article-meta-extra">										
             <?php
               if(current_user_can('edit_post', $post->ID)){
             		edit_post_link(__('Edit', 'exray'), '<p><span class="icon left-meta-icon">S</span>&nbsp;', '</p>', '');
             	}
             ?>		
		</p>
	</div> 
...
?>
	<div class="post-pagination">
		...
		<?php $args = array(
			'before'=>'<nav class="post-pagination menu">'.'<span class="post-pagination title">'.__('Pages: ', 'exray').'</span>',
			'after'=>'</nav>',
...
function get_exray_primary_sidebar(){
	...
	if(!array_key_exists('layout_options', $exray_general_options) ){
		$exray_general_options['layout_options'] = 'default';
