...
= 1.5.2 =
* Fix theme customizer bug on layout chooser custom field radio image.
* Fix jQuery error on admin area.
* Remove deprecated theme tags from style.css.
* Update theme URI.
* Update theme text domain from exray-framework to exray
...
* Implement add_theme_support( 'title-tag' );
* Paginated navigation Options for archive Posts / Pages
* Fix theme slug to exray-framework
* Remove unused files
